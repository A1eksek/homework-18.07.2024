...
nyan_surface = pygame.image.load('images/car.png').convert_alpha()

particle1 = ParticlePrinciple()
# particle2 = ParticleStar()
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == PARTICLE_EVENT:
            particle1.add_particles(-30, pygame.Color('Red'))
            particle1.add_particles(-18, pygame.Color('Red'))
            particle1.add_particles(-6, pygame.Color('Orange'))
            particle1.add_particles(6, pygame.Color('Orange'))
            particle1.add_particles(18, pygame.Color('Yellow'))
            particle1.add_particles(30, pygame.Color('Yellow'))
